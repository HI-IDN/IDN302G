...
Skráin myndi heita [app.R](https://github.com/HI-IDN/IDN302G/blob/main/code/app.R) og vera í möppu sem heitir til dæmis `shiny_app` og á
sama stað væri gagnamappan vera `data` sem inniheldur gagnagrunninn
[`isfolkid.db`](https://github.com/HI-IDN/IDN302G/raw/main/data/isfolkid.db). Við keyrum upp appið úr kóða möppunni með skeljarskipuninni:
