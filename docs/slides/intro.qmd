...
::: {.card}
<h3>Reglulegar segðir</h3>

Leit, mynstragreining og vinnsla textagagna.
:::
...
::: {.callout}
Issue → branch → draft PR → eigin yfirferð → kóðarýni → merge → release
:::

PR á að vera nógu lítið til að hægt sé að rýna það vel.

Ef breytingin er orðin of víðfem er það merki um að skipta henni upp.
...
Erindrekar geta hjálpað við:

- að skrifa eða endurskipuleggja kóða,
- að útskýra villur,
- að gera fyrstu drög að texta,
- að rýna breytingar,
- að finna hvað þarf að prófa betur.

::: {.callout}
En: teymið þarf alltaf að skilja, prófa og sannreyna niðurstöðuna.
:::
...
Ef erindreki hefur marktæk áhrif á vinnuna á branchi á að skrá það í `AGENT_LOG.md`.
...
- hvað teymið yfirfór,
- hvað þurfti að laga handvirkt.

---

## Fyrstu skref

1. Staðfesta GitHub-aðgang.
2. Skoða námskeiðsbókina og templates.
3. Mynda teymi.
4. Velja eða móta capstone-þema.
5. Byrja á issue áður en branch og PR verða til.
