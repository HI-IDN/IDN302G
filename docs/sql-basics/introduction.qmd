...
Samkvæmt [DB-Engines Ranking](https://db-engines.com/en/ranking) voru vinsælustu gagnagrunnskerfin í
september 2026:
...
Hægt er að skoða lifandi röðunina beint hjá DB-Engines:

```{=html}
<iframe
  src="https://db-engines.com/en/ranking"
...
<p>
  Ef taflan birtist ekki hér má opna hana beint á
