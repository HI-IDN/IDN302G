...
Samkvæmt [DB-Engines Ranking](https://db-engines.com/en/ranking) voru vinsælustu gagnagrunnskerfin
í september 2026:
...
Setningafræðin hér að ofan er staðfest í opinberum skjölum fyrir
[PostgreSQL](https://www.postgresql.org/docs/current/queries-limit.html),
[MySQL](https://dev.mysql.com/doc/refman/8.4/en/select.html),
[SQLite](https://www.sqlite.org/lang_select.html),
[Microsoft SQL Server](https://learn.microsoft.com/en-us/sql/t-sql/queries/top-transact-sql),
[Oracle](https://docs.oracle.com/en/database/oracle/oracle-database/26/sqlrf/SELECT.html) og
[IBM Db2](https://www.ibm.com/docs/en/db2-for-zos/12.0.0?topic=selection-fetching-limited-number-rows).
...
Sjá einnig opinber skjöl fyrir
[Snowflake](https://docs.snowflake.com/en/sql-reference/constructs/limit),
[Databricks SQL](https://docs.databricks.com/aws/en/sql/language-manual/sql-ref-syntax-qry-select-limit),
[MongoDB](https://www.mongodb.com/docs/manual/reference/method/db.collection.find/) og
[Redis Search](https://redis.io/docs/latest/commands/ft.search/).
