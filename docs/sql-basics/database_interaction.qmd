...
Uppsetning á _PostgreSQL_ og á þróunarumhverfi (DataGrip, DBeaver eða VS Code) — ásamt því
hvernig tengjast á gagnagrunni — er í [Tæknimál → Gagnagrunnstól](../tech-setup/databases.qmd).
